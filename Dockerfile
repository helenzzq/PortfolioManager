...
COPY --from=compile /usr/src/mymaven/target/portfolioManager-IanB-0.0.1-SNAPSHOT.jar app.jar
COPY --from=compile /usr/src/main/resources/application-docker.properties application.properties
EXPOSE 8080
ENV JAVA_OPTS=""
